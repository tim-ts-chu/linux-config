...
" Version 2010-02-21 from http://vim.wikia.com/wiki/csv
...
function! s:SortColumn(bang, ...) range
...
command! -bang -buffer -nargs=* -range=% Sort <line1>,<line2>call s:SortColumn('<bang>', <f-args>)
